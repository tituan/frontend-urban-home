    ...
    <footer className={styles.footer}>
      <div className={styles.footer__container}>
        ...
        <div className={styles.footer__contacts}>
          ...
          <a href="https://www.airbnb.fr/rooms/1085440006957941054?guests=1&adults=1&s=67&unique_share_id=f71486ca-60f2-47c6-9fc1-44f14c138f0e" target="_blank" rel="noopener noreferrer" className={styles.footer__link}>
            Book more nights
          </a>
